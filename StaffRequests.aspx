                        ...
                        <div class="request-card <%# Eval(" StatusCss") %>">
                            ...
                            <div class="request-details">
                                ...
                                <div class="request-actions">
                                    <asp:Button runat="server" CssClass="btn-request btn-accept" Text="Accept"
                                        CommandName="Accept" CommandArgument='<%# Eval("Id") %>' />
                                    <asp:Button runat="server" CssClass="btn-request btn-decline" Text="Decline"
